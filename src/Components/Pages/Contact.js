...
const Contact = () => {
  return (
    ...
    <p className='text-[42px] text-white '>Contact</p>
    <p>NOTE: We do not accept any movies reqest / support request from INDIA, We'll ignore such kind of messages most of the times, <span className=''>repeated violators will be banned.</span></p>
